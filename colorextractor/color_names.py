"""CSS3 extended color keyword table, used to label extracted colors
with a human-readable nearest name."""
...
def closest_color_name(rgb):
    """Return the CSS3 keyword whose color is nearest to `rgb` (Euclidean distance)."""
    r, g, b = rgb
    best_name = None
    best_distance = None
    for name, (cr, cg, cb) in CSS3_NAMES_TO_RGB.items():
